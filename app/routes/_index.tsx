...
export const meta: V2_MetaFunction = () => {
  return [{ title: 'Ship tool' }, { className: 'description', content: 'Welcome to Remix!' }];
};
                ...
                onClick={() => {
                  ...
                  handleSendMessage(content)
                    .then((message) => {
                      ...
                      document.getElementById('alert').classList.replace('hidden', 'flex');
                      setTimeout(() => {
                        document.getElementById('alert').classList.replace('flex', 'hidden');
                      }, 5000);
                    })
                    .catch((error) => {
